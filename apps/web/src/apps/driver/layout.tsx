...
export function DriverDashboardShell({ children }: { children: ReactNode }) {
  return (
    <div className="driver-dashboard min-h-[70vh] text-[var(--fg)]">
      <header className="mb-8 flex flex-col gap-4 border-b border-[rgb(var(--stroke-rgb)/0.12)] pb-6 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-bold tracking-tight">Fleet</h1>
        </div>
        <nav className="flex flex-wrap gap-2 text-sm">
          <Link
            ...
            className={clsx(
              ...
              "bg-[rgb(var(--surface-rgb)/var(--surface-alpha))] backdrop-blur-md",
            )}
          >
            Overview
          </Link>
